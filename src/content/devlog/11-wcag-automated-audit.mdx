...
- The "outside-click closes the mobile menu" claim was true, but unlike ESC it did not restore focus to the trigger. Added the same `mobileMenuButton.focus()` to the outside-click branch so keyboard users get the same behavior either way.
