...
<CalloutBox type="info" title="Development Principles">
  <p class="mb-2">
    For every future development step, we will adhere to these core principles:
  </p>
  <ul class="list-disc pl-5 space-y-1">
    ...
    <li><strong>Component Awareness</strong>: Reference and update COMPONENTS.md as we develop to maintain a consistent component library</li>
...
<ul>
  ...
  <li><strong>MDX Integration Exploration</strong> - Evaluating how to add MDX support while maintaining our component system</li>
...
<p>
  ...
  feel good to use. Through Signals & Systems, we'll explore how vibecoding can be applied to create more intuitive, human-centered digital experiences.
</p>
